...
def average(numbers):
    ...
    for numero in numbers:
        total += numero
    return round(total / len(numbers), 1)  # Remove this line and implement
...
def describe(numbers):
    ...
    if len(numbers) == 0:
        return "Empty list"
    return f"Min:{find_min(numbers)} Max:{find_max(numbers)} Range:{range_of(numbers)} Avg:{average(numbers)}"  # Remove this line and implement
